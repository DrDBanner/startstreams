...
## Usage 
Download startstreams.sh file, open Terminal, navigate to scripts location and exectute with sh startstreams.sh or ./startstreams.sh if the file has execution permission.
